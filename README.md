...
- «Настройки»: глобальные параметры — контекст, длина ответа, окно токенов, вероятность и кулдаун вмешательств, выбор провайдера LLM, а также все настройки персональной памяти и retrieval.
