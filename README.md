...
- «Настройки»: глобальные параметры — контекст, длина ответа, окно токенов, вероятность и кулдаун вмешательств, выбор провайдера LLM, настройки персональной памяти и количество сообщений, по которым бот придумывает автозвание для `/roll`.
