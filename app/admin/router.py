...
def _render_app_config_body(
    ...
    *,
    ...
    return (
        ...
        "<label class='form-check-label'>Включить память по участникам чата</label>"
        "</div>"
        "</div>"
        "<div class='col-md-6 d-flex align-items-end'>"
        "<div class='form-check form-switch'>"
        f"<input class='form-check-input' type='checkbox' name='memory_sidecar_enabled' value='1'{' checked' if memory_sidecar_enabled else ''}>"
        "<label class='form-check-label'>Обновлять память и отношения в том же LLM-запросе</label>"
        "</div>"
        "</div>"
        "<div class='col-md-4'>"
        ...
        "</div>"
        "<div class='col-md-4'>"
        "<label class='form-label'>Сообщений-кандидатов для поиска по памяти</label>"
        f"<input class='form-control' type='number' name='memory_rag_candidate_limit' min='20' max='500' value='{memory_rag_candidate_limit}'>"
        "</div>"
        "<div class='col-md-4'>"
        "<label class='form-label'>Участников в групповом memory-контексте</label>"
